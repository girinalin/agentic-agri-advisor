(() => {
  ...
  const EN = {
    ...
    'landing.auth.fieldNameLabel': 'Field Name',
  ...
  const HI = {
    ...
    'landing.auth.fieldNameLabel': 'खेत का नाम',
  ...
  const MR = {
    ...
    'landing.auth.fieldNameLabel': 'शेताचे नाव',
    'landing.auth.emailLabel': 'ईमेल',
    'landing.auth.regionLabel': 'स्थान',
  ...
  const TE = {
    ...
    'landing.auth.fieldNameLabel': 'పొలం పేరు',
  ...
  const SW = {
    ...
    'landing.auth.fieldNameLabel': 'Jina la Shamba',
  ...
  const ZU = {
    ...
    'landing.auth.fieldNameLabel': 'Igama Lensimu',
