...
def validate_contracts():
    ...
    try:
        with open('ui/agui/local_db.js', encoding='utf-8') as f:
            assert "KrishiSamparkDB" in f.read(), "Database name mismatch in local_db.js"
        with open('app/fast_api_app.py', encoding='utf-8') as f:
            api_code = f.read()
