...
def generate_matrix():
    matrix = {
        ...
        "REQ-AAA-004": {
            ...
            "adr": "ADR-AAA-004",
            "source_files": ["agents/coordinator/agent.py", "ui/agui/dashboard.js"],
        ...
        "REQ-AAA-005": {
            ...
            "adr": "ADR-AAA-005",
            "source_files": ["app/fast_api_app.py"],
        ...
        "REQ-AAA-006": {
            ...
            "tests": ["tests/integration/test_collapsible_nav.py"],
            "controls": "Outbreak-Triage-Queue",
        },
        "REQ-AAA-007": {
            "title": "Reliable DLQ & Synchronization Queue",
            "adr": "ADR-AAA-007",
            "source_files": ["ui/agui/local_db.js", "ui/agui/dashboard.js"],
        ...
        "REQ-AAA-009": {
            ...
            "adr": "ADR-AAA-009",
            "source_files": ["ui/agui/index.html", "ui/agui/dashboard.js"],
            "tests": ["tests/integration/test_collapsible_nav.py"],
